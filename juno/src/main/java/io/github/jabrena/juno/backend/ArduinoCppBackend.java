...
public final class ArduinoCppBackend {
    ...
    private static final Set<Intrinsic> RUNTIME_STRING_INTRINSICS = EnumSet.of(
            ...
            Intrinsic.STRING_CHAR_AT, Intrinsic.JSON_GET_STRING_VALUE, Intrinsic.STRING_BUILDER_TO_STRING);
    private static final Set<Intrinsic> STRING_BUILDER_INTRINSICS = EnumSet.of(
            Intrinsic.STRING_BUILDER_NEW, Intrinsic.STRING_BUILDER_APPEND_CHAR,
            Intrinsic.STRING_BUILDER_APPEND_STRING, Intrinsic.STRING_BUILDER_TO_STRING);
    ...
    public String generate(IrProgram program) {
        ...
        boolean usesStringBuilder = usesAnyIntrinsic(program, STRING_BUILDER_INTRINSICS);
        ...
        if (usesFloatingPoint || usesJson || usesRuntimeStrings || usesStringBuilder) {
        ...
        if (usesStringBuilder) {
            output.append(stringBuilderHelpers());
        }
    ...
    private String intrinsicExpression(Intrinsic intrinsic) {
        return switch (intrinsic) {
            ...
            case STRING_BUILDER_NEW -> "juno_string_builder_new(call_arg0)";
            case STRING_BUILDER_APPEND_CHAR -> "juno_string_builder_append_char(call_receiver, call_arg0)";
            case STRING_BUILDER_APPEND_STRING -> "juno_string_builder_append_string(call_receiver, call_str0)";
            case STRING_BUILDER_TO_STRING -> "juno_string_builder_to_string(call_receiver)";
            ...
            case HTTP_GET -> "juno_http_get(call_str0, call_arg0, call_str1, "
                    ...
                    + "reinterpret_cast<uint8_t*>(call_arg3), call_arg4, reinterpret_cast<int32_t*>(call_arg5))";
    ...
    private String stringBuilderHelpers() {
        return """
                ...
                static int32_t juno_string_builder_new(int32_t capacity) {
                ...
                static int32_t juno_string_builder_append_char(int32_t handle, int32_t value) {
                  auto* header = reinterpret_cast<int32_t*>(static_cast<intptr_t>(handle));
                ...
                static int32_t juno_string_builder_append_string(int32_t handle, const char* text) {
                  auto* header = reinterpret_cast<int32_t*>(static_cast<intptr_t>(handle));
                ...
                static int32_t juno_string_builder_to_string(int32_t handle) {
                  auto* header = reinterpret_cast<int32_t*>(static_cast<intptr_t>(handle));
