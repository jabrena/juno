...
public final class IntrinsicRegistry {
    ...
    private static final Map<MethodRef, Intrinsic> METHODS = Map.ofEntries(
            ...
            Map.entry(new MethodRef("io/github/jabrena/juno/api/motors/Servo", "of",
                    "(I)Lio/github/jabrena/juno/api/motors/Servo;"), Intrinsic.SERVO_OF),
            Map.entry(new MethodRef("io/github/jabrena/juno/api/motors/Servo", "write", "(I)V"),
                    Intrinsic.SERVO_WRITE),
