...
public final class IntrinsicRegistry {
    private static final Map<MethodRef, Intrinsic> METHODS = Map.ofEntries(
            ...
            Map.entry(new MethodRef("io/github/jabrena/juno/api/LedMatrix", "begin", "()V"),
                    Intrinsic.LED_MATRIX_BEGIN),
            Map.entry(new MethodRef("io/github/jabrena/juno/api/LedMatrix", "loadFrame", "(III)V"),
                    Intrinsic.LED_MATRIX_LOAD_FRAME),
            Map.entry(new MethodRef("io/github/jabrena/juno/api/LedMatrix", "clear", "()V"),
