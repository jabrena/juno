...
public final class IntrinsicRegistry {
    private static final Map<MethodRef, Intrinsic> METHODS = Map.ofEntries(
            ...
            Map.entry(new MethodRef("io/github/jabrena/juno/api/net/HttpsClient", "get",
                    "(Ljava/lang/String;ILjava/lang/String;[BI)I"), Intrinsic.HTTPS_GET),
            Map.entry(new MethodRef("io/github/jabrena/juno/api/net/HttpsClient", "post",
                    "(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;[BI)I"), Intrinsic.HTTPS_POST),
            Map.entry(new MethodRef("io/github/jabrena/juno/api/net/HttpsClient", "delete",
                    "(Ljava/lang/String;ILjava/lang/String;[BI)I"), Intrinsic.HTTPS_DELETE),
            Map.entry(new MethodRef("io/github/jabrena/juno/api/net/HttpsClient", "patch",
                    "(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;[BI)I"), Intrinsic.HTTPS_PATCH),
            Map.entry(new MethodRef("io/github/jabrena/juno/api/net/HttpsClient", "query",
